...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Menyiapkan pernyataan SQL untuk memasukkan data ke dalam tabel dokter
    $sql = "INSERT INTO tb_data_penulis VALUES ('$id_data_penulis','$id_penulis', '$judul', '$isi', '$status_berita')";
